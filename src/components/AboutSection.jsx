          ...
          <div className="w-full">
            ...
            <div className="relative mb-6">
              ...
              <div className="absolute bottom-4 left-4 bg-slate-900 text-white p-4 lg:p-5 rounded-xl shadow-lg border-l-4 border-cyan-500 w-40">
                ...
                <p className="text-xs text-slate-300 mt-1">Dự án thành công</p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-100 p-5 rounded-xl flex items-center gap-4">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm">Đội ngũ chuyên nghiệp</h4>
                <p className="text-xs text-slate-500 mt-1">Kỹ sư, chuyên gia & nhà tư vấn công nghệ</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full space-y-6">
            ...
            <div className="bg-slate-50/80 border-l-[6px] border-cyan-500 rounded-r-xl p-6 shadow-sm">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-bold text-slate-900 uppercase text-sm tracking-wide">Tầm nhìn</h4>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed">
                Trở thành công ty công nghệ hàng đầu khu vực Đông Nam Á, cung cấp các giải pháp phần mềm sáng tạo và dẫn đầu xu hướng chuyển đổi số cho doanh nghiệp vừa và lớn.
              </p>
            </div>
            ...
            <div className="bg-orange-50/50 border-l-[6px] border-orange-500 rounded-r-xl p-6 shadow-sm">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-bold text-slate-900 uppercase text-sm tracking-wide">Sứ mệnh</h4>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed">
                Mang công nghệ tiên tiến đến gần hơn với mọi doanh nghiệp Việt Nam — giúp họ tối ưu hóa quy trình, bảo mật dữ liệu, và tăng trưởng bền vững trong thời đại số.
              </p>
            </div>
            ...
            <div className="bg-slate-50/80 border-l-[6px] border-slate-900 rounded-r-xl p-6 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="font-bold text-slate-900 uppercase text-sm tracking-wide">Giá trị cốt lõi</h4>
              </div>
              
              <div className="flex flex-wrap gap-2">
                <span className="bg-slate-900 text-white text-xs px-4 py-1.5 rounded-full font-medium">Sáng tạo</span>
                <span className="bg-slate-900 text-white text-xs px-4 py-1.5 rounded-full font-medium">Chính trực</span>
                <span className="bg-slate-900 text-white text-xs px-4 py-1.5 rounded-full font-medium">Hiệu quả</span>
                <span className="bg-slate-900 text-white text-xs px-4 py-1.5 rounded-full font-medium">Tin cậy</span>
              </div>
            </div>
