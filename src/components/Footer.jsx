...
const Footer = () => {
  return (
    <footer className="bg-white py-6 border-t border-gray-200 shadow-inner mt-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
            <div className="flex items-center gap-5">
              <a href="#" className="text-slate-900 hover:text-cyan-500 transition-colors transform hover:scale-110">
